...
SECRET_KEY = 'django-insecure-r9o8m+==cvvm&8k)$v$zgnm18#d3%^$&m)v$%6$%wx+u#%y(!t'
...
RAZORPAY_KEY_ID = 'rzp_test_SpY1AvFCGERwJt'
RAZORPAY_KEY_SECRET = 'stmqxF3AY7QcrahqJinK7nqX'
